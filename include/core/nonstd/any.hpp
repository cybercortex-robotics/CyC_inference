...
{
   auto result = any_cast< typename std11::add_const< typename std11::remove_reference<ValueType>::type >::type >( &operand );
...
{
   auto result = any_cast< typename std11::remove_reference<ValueType>::type >( &operand );
