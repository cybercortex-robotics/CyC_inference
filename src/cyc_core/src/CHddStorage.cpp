...
void write_header(CCycFilterBase* pFilter, std::ofstream& writer)
{
    ...
    case CyC_GPS:
    {
        writer << "timestamp_stop,sampling_time,lat,lng,alt,num_satelites,fix_type" << std::endl;
    }
    break;
    case CyC_STATE:
    {
...
void CHddStorage::generateFilterOutputStructures(CCycFilterBase* _pFilter, std::string _datastream_storage_folder)
{
    ...
    case CyC_GPS:
    {
        CsvWritter << "timestamp_stop,sampling_time,lat,lng,alt,num_satelites,fix_type" << std::endl;
    }
    break;
